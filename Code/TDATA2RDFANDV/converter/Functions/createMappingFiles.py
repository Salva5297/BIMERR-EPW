...
map:om_0 a rr:ObjectMap;
    rr:template "https://bimerr.linkeddata.es/resource/weather/{typeOfPeriod}/{season}/{adm03}_{city}_{wmo}";
    rr:termType rr:IRI.
...
map:om_101 a rr:ObjectMap;
    rr:template "https://bimerr.linkeddata.es/resource/weather/{epwName}/{adm03}_{city}_{wmo}";
    rr:termType rr:IRI.
map:om_102 a rr:ObjectMap;
    rr:constant "https://bimerr.iot.linkeddata.es/def/weather#TotalSkyCover";
    rr:termType rr:IRI.
map:om_103 a rr:ObjectMap;
    rr:template "https://bimerr.linkeddata.es/resource/weather/Device/{adm03}_{city}_{wmo}";
    rr:termType rr:IRI.
...
map:om_182 a rr:ObjectMap;
    rr:template "https://bimerr.linkeddata.es/resource/weather/city/{city}";
    rr:termType rr:IRI.
map:om_183 a rr:ObjectMap;
    rr:template "https://bimerr.linkeddata.es/resource/weather/country/{country}";
    rr:termType rr:IRI.
map:om_184 a rr:ObjectMap;
    rr:template "https://bimerr.linkeddata.es/resource/weather/Point/{adm03}_{city}_{wmo}";
    rr:termType rr:IRI.
...
map:om_189 a rr:ObjectMap;
    rr:template "https://bimerr.linkeddata.es/resource/weather/GroundConductivity/{adm03}_{city}_{wmo}_{groundTemperatureDepth}";
    rr:termType rr:IRI.
map:om_19 a rr:ObjectMap;
    rr:template "https://bimerr.linkeddata.es/resource/weather/Device/{adm03}_{city}_{wmo}";
    rr:termType rr:IRI.
map:om_190 a rr:ObjectMap;
    rr:template "https://bimerr.linkeddata.es/resource/weather/GroundTemperatureDepth/{adm03}_{city}_{wmo}_{groundTemperatureDepth}";
    rr:termType rr:IRI.
map:om_191 a rr:ObjectMap;
    rr:template "https://bimerr.linkeddata.es/resource/weather/GroundDensity/{adm03}_{city}_{wmo}_{groundTemperatureDepth}";
    rr:termType rr:IRI.
map:om_192 a rr:ObjectMap;
    rr:template "https://bimerr.linkeddata.es/resource/weather/GroundSpecificHeat/{adm03}_{city}_{wmo}_{groundTemperatureDepth}";
    rr:termType rr:IRI.
map:om_193 a rr:ObjectMap;
    rr:template "https://bimerr.linkeddata.es/resource/weather/GroundTemperature/{adm03}_{city}_{wmo}_{groundTemperatureDepth}";
    rr:termType rr:IRI.
map:om_194 a rr:ObjectMap;
    rr:template "https://bimerr.linkeddata.es/resource/weather/DryBulbTemperatureMeasurement/{adm03}_{city}_{Year}-{Month}-{Day}-{Hour}";
    rr:termType rr:IRI.
map:om_195 a rr:ObjectMap;
    rr:template "https://bimerr.linkeddata.es/resource/weather/DewPointTemperatureMeasurement/{adm03}_{city}_{Year}-{Month}-{Day}-{Hour}";
    rr:termType rr:IRI.
map:om_196 a rr:ObjectMap;
    rr:template "https://bimerr.linkeddata.es/resource/weather/RelativeHumidityMeasurement/{adm03}_{city}_{Year}-{Month}-{Day}-{Hour}";
    rr:termType rr:IRI.
map:om_197 a rr:ObjectMap;
    rr:template "https://bimerr.linkeddata.es/resource/weather/AtmosphericStationPressureMeasurement/{adm03}_{city}_{Year}-{Month}-{Day}-{Hour}";
    rr:termType rr:IRI.
map:om_198 a rr:ObjectMap;
    rr:template "https://bimerr.linkeddata.es/resource/weather/ExtraterrestrialHorizontalRadiationMeasurement/{adm03}_{city}_{Year}-{Month}-{Day}-{Hour}";
    rr:termType rr:IRI.
map:om_199 a rr:ObjectMap;
    rr:template "https://bimerr.linkeddata.es/resource/weather/ExtraterrestrialDirectNormalRadiationMeasurement/{adm03}_{city}_{Year}-{Month}-{Day}-{Hour}";
    rr:termType rr:IRI.
...
map:om_200 a rr:ObjectMap;
    rr:template "https://bimerr.linkeddata.es/resource/weather/HorizontalInfraredRadiationIntensityMeasurement/{adm03}_{city}_{Year}-{Month}-{Day}-{Hour}";
    rr:termType rr:IRI.
map:om_201 a rr:ObjectMap;
    rr:template "https://bimerr.linkeddata.es/resource/weather/GlobalHorizontalRadiationMeasurement/{adm03}_{city}_{Year}-{Month}-{Day}-{Hour}";
    rr:termType rr:IRI.
map:om_202 a rr:ObjectMap;
    rr:template "https://bimerr.linkeddata.es/resource/weather/DirectNormalRadiationMeasurement/{adm03}_{city}_{Year}-{Month}-{Day}-{Hour}";
    rr:termType rr:IRI.
map:om_203 a rr:ObjectMap;
    rr:template "https://bimerr.linkeddata.es/resource/weather/DiffuseHorizontalRadiationMeasurement/{adm03}_{city}_{Year}-{Month}-{Day}-{Hour}";
    rr:termType rr:IRI.
map:om_204 a rr:ObjectMap;
    rr:template "https://bimerr.linkeddata.es/resource/weather/GlobalHorizontalIlluminanceMeasurement/{adm03}_{city}_{Year}-{Month}-{Day}-{Hour}";
    rr:termType rr:IRI.
map:om_205 a rr:ObjectMap;
    rr:template "https://bimerr.linkeddata.es/resource/weather/DirectNormalIlluminanceMeasurement/{adm03}_{city}_{Year}-{Month}-{Day}-{Hour}";
    rr:termType rr:IRI.
map:om_206 a rr:ObjectMap;
    rr:template "https://bimerr.linkeddata.es/resource/weather/DiffuseHorizontalIlluminanceMeasurement/{adm03}_{city}_{Year}-{Month}-{Day}-{Hour}";
    rr:termType rr:IRI.
map:om_207 a rr:ObjectMap;
    rr:template "https://bimerr.linkeddata.es/resource/weather/ZenithLuminanceMeasurement/{adm03}_{city}_{Year}-{Month}-{Day}-{Hour}";
    rr:termType rr:IRI.
map:om_208 a rr:ObjectMap;
    rr:template "https://bimerr.linkeddata.es/resource/weather/WindDirectionMeasurement/{adm03}_{city}_{Year}-{Month}-{Day}-{Hour}";
    rr:termType rr:IRI.
map:om_209 a rr:ObjectMap;
    rr:template "https://bimerr.linkeddata.es/resource/weather/WindSpeedMeasurement/{adm03}_{city}_{Year}-{Month}-{Day}-{Hour}";
    rr:termType rr:IRI.
...
map:om_210 a rr:ObjectMap;
    rr:template "https://bimerr.linkeddata.es/resource/weather/TotalSkyCoverMeasurement/{adm03}_{city}_{Year}-{Month}-{Day}-{Hour}";
    rr:termType rr:IRI.
map:om_211 a rr:ObjectMap;
    rr:template "https://bimerr.linkeddata.es/resource/weather/OpaqueSkyCoverMeasurement/{adm03}_{city}_{Year}-{Month}-{Day}-{Hour}";
    rr:termType rr:IRI.
map:om_212 a rr:ObjectMap;
    rr:template "https://bimerr.linkeddata.es/resource/weather/VisibilityMeasurement/{adm03}_{city}_{Year}-{Month}-{Day}-{Hour}";
    rr:termType rr:IRI.
map:om_213 a rr:ObjectMap;
    rr:template "https://bimerr.linkeddata.es/resource/weather/CeilingHeightMeasurement/{adm03}_{city}_{Year}-{Month}-{Day}-{Hour}";
    rr:termType rr:IRI.
map:om_214 a rr:ObjectMap;
    rr:template "https://bimerr.linkeddata.es/resource/weather/PrecipitableWaterMeasurement/{adm03}_{city}_{Year}-{Month}-{Day}-{Hour}";
    rr:termType rr:IRI.
map:om_215 a rr:ObjectMap;
    rr:template "https://bimerr.linkeddata.es/resource/weather/AerosolOpticalDepthMeasurement/{adm03}_{city}_{Year}-{Month}-{Day}-{Hour}";
    rr:termType rr:IRI.
map:om_216 a rr:ObjectMap;
    rr:template "https://bimerr.linkeddata.es/resource/weather/SnowDepthMeasurement/{adm03}_{city}_{Year}-{Month}-{Day}-{Hour}";
    rr:termType rr:IRI.
map:om_217 a rr:ObjectMap;
    rr:template "https://bimerr.linkeddata.es/resource/weather/DaysSinceLastSnowfallMeasurement/{adm03}_{city}_{Year}-{Month}-{Day}-{Hour}";
    rr:termType rr:IRI.
map:om_218 a rr:ObjectMap;
    rr:template "https://bimerr.linkeddata.es/resource/weather/AlbedoMeasurement/{adm03}_{city}_{Year}-{Month}-{Day}-{Hour}";
    rr:termType rr:IRI.
map:om_219 a rr:ObjectMap;
    rr:template "https://bimerr.linkeddata.es/resource/weather/LiquidPrecipitationDepthMeasurement/{adm03}_{city}_{Year}-{Month}-{Day}-{Hour}";
    rr:termType rr:IRI.
...
map:om_220 a rr:ObjectMap;
    rr:template "https://bimerr.linkeddata.es/resource/weather/LiquidPrecipitationQuantityMeasurement/{adm03}_{city}_{Year}-{Month}-{Day}-{Hour}";
    rr:termType rr:IRI.
...
map:om_3 a rr:ObjectMap;
    rr:template "https://bimerr.linkeddata.es/resource/weather/{epwName}/{adm03}_{city}_{wmo}/{adm03}_{city}_{wmo}";
    rr:termType rr:IRI.
...
map:s_62 a rr:SubjectMap;
    rr:template "https://bimerr.linkeddata.es/resource/weather/{epwName}/{adm03}_{city}_{wmo}~iri".
...
map:s_67 a rr:SubjectMap;
    rr:template "https://bimerr.linkeddata.es/resource/weather/{epwName}".
